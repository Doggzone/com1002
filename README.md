...
### 교재
- 도경구 저, 코딩의 정석 - Python, 생능출판사, 2020.
...
|  4  | 9/21(월),24(목) | 제어 구조 | #3 | #3 |
|  5  | 9/28(월), 10/5(월) | 재귀와 반복 : 자연수 계산 | #4 | #4 |
|  6  | 10/8(목),12(월) | 재귀와 반복 : 정렬 | #5 | #5 |
|  7  | 10/15(목),19(월) | 재귀와 반복 : 검색 | #6 | #6 |
|  8  | 10/(22,26) | (오프라인) 코딩시험1 | - | - |
|  9  | 10/29(목), 11/2(월) | 표채워풀기 | #7 | #7 |
|  10 | 11/5(목),9(월) | 프로젝트 기반 학습 I - 퍼즐게임 스도쿠 | #8 | #8 |
|  11 | 11/12(목),16(월) | 프로젝트 기반 학습 II - 카드게임 블랙잭 | #9 | #9 |
|  12 | 11/19(목),23(월) | 프로젝트 기반 학습 II - 카드게임 블랙잭 (계속) | #10 | - |
|  13 | 11/26(목),30(월) | (오프라인) 팀 프로젝트 제안 | - | - |
|  14 | 12/3(목) | 예외 처리 | - | - |
|  15 | 12/7(월),10(목) | (오프라인) 팀 프로젝트 시연 | - | - |
|  16 | 12/(14,17) | (오프라인) 코딩시험2 | - | - |
...
- 조교: xxx, 제4공학관 3층 319호 프로그래밍언어연구실
