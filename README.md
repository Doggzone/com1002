...
|  8  |  | (오프라인) 코딩시험 | - | - |
|  9  |  | 표채워풀기 | #7 | #7 |
|  10 |  | 프로젝트 기반 학습 I - 퍼즐게임 스도쿠 | #8 | #8 |
|  11 |  | 프로젝트 기반 학습 II - 카드게임 블랙잭 | #9 | #9 |
|  12 |  | 프로젝트 기반 학습 II - 카드게임 블랙잭 (계속) | #10 | - |
|  13 |  | (오프라인) 팀 프로젝트 제안 밢표 | - | - |
|  14 |  | 예외 처리 | - | - |
|  15 |  | (오프라인) 팀 프로젝트 데모 발표 | - | - |
