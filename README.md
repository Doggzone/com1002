...
|  1  | 9/3 | 수업 소개 | - | - |
|  2  | 9/7,10 | 식 | #1 | #1 |
|  3  | 9/14,17 | 변수와 함수 | #2 | #2 |
|  4  | 9/21,24 | 제어 구조 | #3 | #3 |
|  5  | 9/28, 10/5 | 재귀와 반복 : 자연수 계산 | #4 | #4 |
|  6  | 10/8,12 | 재귀와 반복 : 정렬 | #5 | #5 |
|  7  | 10/15,19 | 재귀와 반복 : 검색 | #6 | #6 |
|  8  | 10/(22,26) | (오프라인) 코딩시험1 | - | - |
|  9  | 10/29, 11/2 | 표채워풀기 | #7 | #7 |
|  10 | 11/5,9 | 프로젝트 기반 학습 I - 퍼즐게임 스도쿠 | #8 | #8 |
|  11 | 11/12,16 | 프로젝트 기반 학습 II - 카드게임 블랙잭 | #9 | #9 |
|  12 | 11/19,23 | 프로젝트 기반 학습 II - 카드게임 블랙잭 (계속) | #10 | - |
|  13 | 11/26,30 | (오프라인) 팀 프로젝트 제안 | - | - |
|  14 | 12/3 | 예외 처리 | - | - |
|  15 | 12/7,10 | (오프라인) 팀 프로젝트 시연 | - | - |
